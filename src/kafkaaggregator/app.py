"""The main application definition for kafkaaggregator service."""
...
from kafkaaggregator.handlers import init_external_routes, init_internal_routes
...
def create_app() -> web.Application:
    ...
    setup_metadata(package_name="kafkaaggregator", app=root_app)
